...
========================================
The most harmfuls and the most damagings
========================================
...
In order to categorise the events, the documentation that comes with the dataset proposes 48 categories (**evtype**) of weather events (StormDataDoc.pdf, p.6, table 1. Storm Data Event Table).
...
The data, insetad, presents more than 900 evtype categories
...
evtype_clean$output[grep("WINTER STORM/HIGH WINDS", evtype_clean$evtype, ignore.case = TRUE)]<- "Winter Storm"
evtype_clean$output[grep("small hail", evtype_clean$evtype, ignore.case = TRUE)]<- "Hail"
evtype_clean$output[grep("NA", evtype_clean$evtype, ignore.case = TRUE)]<- "Others"
